        ...
        while(this.menu.getRun()) {
            switch (menu.getMenu()) {
                ...
                case RegisterClient:
                    ...
                    catch (InvalidNewRegisterException e){ error = erroInvalidNewRegisterException; }
                    catch (UserExistsException e){ error = erroUserExistsException; }
                    break;
                case RegisterOwner:
                    try {
                ...
                case Specific:
                    ...
                    catch (InvalidNewRentalException e) { error = erroInvalidParameters; }
                    break;
                ...
                case CarOverview:
                    ...
                    catch (InvalidNumberOfArgumentsException e) {error = erroInvalidParameters;}
                ...
                case HistoryOwner:
                    ...
                    catch (InvalidTimeIntervalException e){error = erroInvalidTimeIntervalException;}
                    break;
